...
io_modifier_list:
                ...
                ;
io_modifier:
           LESS WORD { free(currCmd -> inFile); currCmd -> inFile = $2; }
           | GREAT WORD { free(currCmd -> outFile); currCmd -> outFile = $2; currCmd -> out_append = 0; }
           | GREATGREAT WORD { free(currCmd -> outFile); currCmd -> outFile = $2; currCmd -> out_append = 1;}
           | AMPERSANDGREAT WORD { free(currCmd -> errFile); currCmd -> errFile = $2; currCmd -> err_append = 0; }
           | AMPERSANDGREATGREAT WORD { free(currCmd -> errFile); currCmd -> errFile = $2; currCmd -> err_append = 1;}
           ;
pipe_list:
